...
extern {
	...
	pub fn wrapper_webview_new(title: *const c_char, url: *const c_char, width: c_int, height: c_int, resizable: c_int, borderless: c_int, debug: c_int, external_invoke_cb: Option<ErasedExternalInvokeFn>, userdata: *mut c_void) -> *mut CWebView;
	...
	pub fn webview_set_icon(this: *mut CWebView, icon: *const c_char, length: u32, width: u32, height: u32);
	pub fn webview_minimize(this: *mut CWebView);
